...
# Lista de palavras
objetos = ["cadeira", "caneta", "mesa"]
planetas = ["mercúrio", "saturno", "marte"]
animais = ["cachorro", "gato", "formiga"]
...
def jogo_da_forca():
    ...
    while True:
        ...
        if tentativas == 0:
            print("Poxa que pena, tenta na próxima:(! A palavra era:", palavra)
            break
